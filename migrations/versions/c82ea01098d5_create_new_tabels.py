...
Revision ID: c82ea01098d5
Revises: 555a64706a39
Create Date: 2025-02-12 06:40:58.198145
...
revision: str = 'c82ea01098d5'
down_revision: Union[str, None] = '555a64706a39'
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', 'item_name')
    )
    # ### end Alembic commands ###
